...
import { ShipMethodRepository } from '../repositories/ShipMethodRepository';
...
import { PurchaseOrderDetailRepository } from '../repositories/PurchaseOrderDetailRepository';
...
container.bind<IPurchaseOrderRepository>(TYPES.IPurchaseOrderRepository).to(PurchaseOrderRepository);
container.bind<IShipMethodRepository>(TYPES.IShipMethodRepository).to(ShipMethodRepository);
...
container.bind<IPurchaseOrderDetailRepository>(TYPES.IPurchaseOrderDetailRepository).to(PurchaseOrderDetailRepository);

// Register services
container.bind<PurchaseOrderService>(TYPES.PurchaseOrderService).to(PurchaseOrderService);
container.bind<ShipMethodService>(TYPES.ShipMethodService).to(ShipMethodService);
...
container.bind<PurchaseOrderDetailService>(TYPES.PurchaseOrderDetailService).to(PurchaseOrderDetailService);

// Register controllers
container.bind<PurchaseOrderController>(PurchaseOrderController).toSelf();
container.bind<ShipMethodController>(ShipMethodController).toSelf();
container.bind<PersonController>(PersonController).toSelf();
container.bind<VendorController>(VendorController).toSelf();
container.bind<PurchaseOrderDetailController>(PurchaseOrderDetailController).toSelf();
